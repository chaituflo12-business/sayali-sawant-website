export type ServiceIcon =
  | "Baby" | "HeartPulse" | "CalendarHeart" | "Microscope" | "Dna" | "Activity"
  | "Stethoscope" | "ShieldCheck" | "Sun" | "Users" | "ClipboardCheck" | "Flower2";

export const SERVICES: ReadonlyArray<{ title: string; body: string; icon: ServiceIcon }> = [
  {
